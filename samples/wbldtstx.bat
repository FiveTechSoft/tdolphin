@echo off
color 80
title pruebas Dolphin 1.0
set /P wfile= Teclee el nombre del test y presione ENTER ::. 

IF NOT EXIST %wfile%.prg GOTO ERRORFILE
CLS
ECHO Compiling...
set hdir=y:\xharbcvs
...
:ERRORFILE
ECHO * El archivo %wfile% no existe, verifique... *
GOTO EXIT
