...
@SET PRG_COMP_LIB_PATH=%PRG_COMP_PATH%\lib\win\msvc64
@SET PRG_COMP_INC_PATH=%PRG_COMP_PATH%\include
@SET C_COMPILER=MSVC64
@SET C_COMP_PATH=c:\vc64
...
@SET INCLUDE=%INCLUDE%;%C_COMP_INC_PATH%
@SET LIB=%LIB%;%C_COMP_LIB_PATH%
