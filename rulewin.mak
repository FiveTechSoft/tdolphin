...
ifeq ($(C_COMPILER),BCC)
	...
	ifeq ($(BLD_TYPE),gtgui)
		STD_OBJS=c0w32.obj
		LIBS= $(GUILIB) $(DOLPHIN_LIBNAME) $(LIBMYSQL) $(addsuffix .$(LIB_EXT), $(LD_LIB) $(STD_LIBS) )	  
		...
		STD_OBJS=c0x32.obj
		LIBS=$(DOLPHIN_LIBNAME) $(LIBMYSQL) $(addsuffix .$(LIB_EXT), $(LD_LIB) $(STD_LIBS) )
...
ifeq ($(C_COMPILER),MSVC32)
	...
	ifeq ($(BLD_TYPE),gtgui)
		...
		LIBS=$(DOLPHIN_LIBNAME) $(LIBMYSQL) $(addsuffix .$(LIB_EXT), $(LD_LIB) $(MSVC_LIB))
		LD_FLAGS=/LIBPATH:"$(C_COMP_PATH)$(SEPARATOR)lib" \
		/LIBPATH:"$(DOLPHIN_LIB)" \
		/LIBPATH:"$(ROOT)$(SEPARATOR)lib$(SEPARATOR)mysql$(SEPARATOR)coff" \
...
ifeq ($(C_COMPILER),MINGW32)
  ...
  MINIGW_LIB=-ldolphin $(LIBMYSQL) $(addprefix -l,$(LD_LIB))
